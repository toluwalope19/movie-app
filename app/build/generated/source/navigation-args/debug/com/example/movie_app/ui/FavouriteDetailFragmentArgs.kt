...
data class FavouriteDetailFragmentArgs(
  val movie: Movie
) : NavArgs {
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): FavouriteDetailFragmentArgs {
      bundle.setClassLoader(FavouriteDetailFragmentArgs::class.java.classLoader)
      val __movie : Movie?
      ...
      return FavouriteDetailFragmentArgs(__movie)
    }
  }
}
